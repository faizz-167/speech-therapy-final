    ...
    for task in TASKS:
        ...
        conn.execute(text("""
            ...
            ON CONFLICT (weight_id) DO UPDATE SET
                speech_w_pa = EXCLUDED.speech_w_pa,
                speech_w_wa = EXCLUDED.speech_w_wa,
                speech_w_fs = EXCLUDED.speech_w_fs,
                speech_w_srs = EXCLUDED.speech_w_srs,
                speech_w_cs = EXCLUDED.speech_w_cs,
                fusion_w_speech = EXCLUDED.fusion_w_speech,
                fusion_w_engagement = EXCLUDED.fusion_w_engagement,
                engagement_w_emotion = EXCLUDED.engagement_w_emotion,
                engagement_w_behavioral = EXCLUDED.engagement_w_behavioral,
                behavioral_w_rl = EXCLUDED.behavioral_w_rl,
                behavioral_w_tc = EXCLUDED.behavioral_w_tc,
                behavioral_w_aq = EXCLUDED.behavioral_w_aq,
                adaptive_advance_threshold = EXCLUDED.adaptive_advance_threshold,
                adaptive_stay_min = EXCLUDED.adaptive_stay_min,
                adaptive_stay_max = EXCLUDED.adaptive_stay_max,
                adaptive_drop_threshold = EXCLUDED.adaptive_drop_threshold,
                adaptive_consecutive_fail_limit = EXCLUDED.adaptive_consecutive_fail_limit,
                rule_severe_pa_threshold = EXCLUDED.rule_severe_pa_threshold,
                rule_severe_pa_score_cap = EXCLUDED.rule_severe_pa_score_cap,
                rule_low_eng_threshold = EXCLUDED.rule_low_eng_threshold,
                rule_low_eng_penalty = EXCLUDED.rule_low_eng_penalty,
                rule_high_eng_threshold = EXCLUDED.rule_high_eng_threshold,
                rule_high_eng_boost = EXCLUDED.rule_high_eng_boost,
                version = EXCLUDED.version,
