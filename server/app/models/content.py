...
class TaskScoringWeights(Base):
    ...
    fusion_w_speech: Mapped[float] = mapped_column(Numeric, default=0.60)
    fusion_w_engagement: Mapped[float] = mapped_column(Numeric, default=0.40)
    engagement_w_emotion: Mapped[float] = mapped_column(Numeric, default=1.00)
    engagement_w_behavioral: Mapped[float] = mapped_column(Numeric, default=0.00)
    ...
    adaptive_stay_min: Mapped[float] = mapped_column(Numeric, default=60.0)
    adaptive_stay_max: Mapped[float] = mapped_column(Numeric, default=74.0)
    adaptive_drop_threshold: Mapped[float] = mapped_column(Numeric, default=60.0)
